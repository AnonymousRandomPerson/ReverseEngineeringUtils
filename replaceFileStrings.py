...
raw_text = raw_text.replace(', 0x70, 0x6b, 0x73, 0x64\n.byte 0x69, 0x72, 0x30, 0x00,', '\n.string "pksdir0\\0"\n.byte')
raw_text = raw_text.replace('.byte 0x70, 0x6b, 0x73, 0x64\n.byte 0x69, 0x72, 0x30, 0x00,', '.string "pksdir0\\0"\n.byte')
raw_text = raw_text.replace('.byte 0x70, 0x6b, 0x73, 0x64\n.byte 0x69, 0x72, 0x30, 0x00\n', '.string "pksdir0\\0"\n')
raw_text = raw_text.replace('.byte 0x70, 0x6b, 0x73, 0x64, 0x69, 0x72, 0x30, 0x00,', '.string "pksdir0\\0"\n.byte')
raw_text = raw_text.replace(', 0x70, 0x6b, 0x73, 0x64\n.byte 0x69, 0x72, 0x30, 0x00,', '\n.string "pksdir0\\0"\n.byte')
raw_text = raw_text.replace('.byte 0x70, 0x6b, 0x73, 0x64, 0x69, 0x72, 0x30, 0x00', '.string "pksdir0\\0"')
raw_text = raw_text.replace(', 0x70, 0x6b, 0x73, 0x64, 0x69, 0x72, 0x30, 0x00,', '\n.string "pksdir0\\0"\n.byte')
raw_text = raw_text.replace(', 0x70, 0x6b, 0x73, 0x64, 0x69, 0x72, 0x30, 0x00', '\n.string "pksdir0\\0"')
