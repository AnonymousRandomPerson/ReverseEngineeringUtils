...
ai_targets = read_offset_data(init_offset=0xE0E0, data_size=26, num_elements=543, data_offset=0x0, read_size=2, index_dict=move_map_sky, binary_values=False, file_path=WAZA_FILE_PATH)